    ...
    return (
        <div className="site-page-content">
            ...
            <div className="text-block">
                {/* <h2>Montassarhajri.com</h2>
                <br />
                <p>
                    Montassarhajri.com is my portfolio website, and also the
                ...
                <p>
                    ...
                    <a
                        rel="noreferrer"
                        target="_blank"
                        href="https://Montassarhajri.vercel.app/"
                    >
                        here
                    </a>{' '}
                ...
                <ul>
                    <li>
                        <a
                            rel="noreferrer"
                            target="_blank"
                            href="https://montassarHajri.com"
                        >
                            <p>
                                <b>[3D Site]</b> - montassarHajri.com
                            </p>
                        </a>
                    </li>
                    <li>
                        ...
                        >
                            <p>
                                <b>[OS Site]</b> - montassarHajri.vercel.app
                            </p>
                        </a>
                    </li>
                    <li>
                        <a
                            rel="noreferrer"
                            target="_blank"
                            href="https://github.com/MontaCoder/portfolio-website"
                        >
                            <p>
                    ...
                    <li>
                        <a
                            rel="noreferrer"
                            target="_blank"
                            href="https://github.com/MontaCoder/portfolio-inner-site"
                        >
                            <p>
                ...
                <p>
                    ...
                    <a
                        rel="noreferrer"
                        target="_blank"
                        href="https://x.com/MontassarHajri_"
                    >
                        @MontassarHajri_
                    </a>
                </p> */}
                ...
                <ul>
                    ...
                    <li>
                        <a
                            rel="noreferrer"
                            target="_blank"
                            href="https://github.com/MontaCoder/foodie"
                        >
                            <p>
                ...
                <ul>
                    ...
                    <li>
                        <a
                            rel="noreferrer"
                            target="_blank"
                            href="https://github.com/MontaCoder/gsts_assets"
                        >
                            <p>
                                <b>[GitHub]</b> - Guntattchment Saga The Sequel
                                Assets Repository
                ...
                <ul>
                    <li>
                        <a
                            rel="noreferrer"
                            target="_blank"
                            href="https://github.com/MontaCoder/skip-the-scroll"
                        >
                            <p>
