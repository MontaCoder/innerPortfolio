...
const CREDITS = [
    {
        ...
        rows: [['Montassar Hajri', 'All']],
    },
    {
        title: 'Modeling & Texturing',
        rows: [
            ['Montassar Hajri', 'Texturing, Composition, & UV'],
    ...
    },
    {
        title: 'Sound Design',
        rows: [
            ['Montassar Hajri', 'Mixing, Composition, & Foley'],
    ...
    },
    {
        ...
        rows: [
            ...
            ['Montassar Hajri', 'Lorelei Kravinsky'],
        ],
    },
];
